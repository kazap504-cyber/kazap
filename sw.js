/* ═══════════════════════════════════════════════════════════════
   ...
   Ce bloc est enregistré depuis index.html (scope "/", cf. le
   script d'enregistrement déjà présent dans le <head>) qui gère
   déjà la détection de nouvelle version et le rechargement de la
   page via skipWaiting() + clients.claim() ci-dessous.
   ═══════════════════════════════════════════════════════════════ */
...
// Adapter cette liste si l'arborescence réelle du site diffère (cf. note
// de blocage envoyée en fin de réponse concernant les chemins d'icônes).
